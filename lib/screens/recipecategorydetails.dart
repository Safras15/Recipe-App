...
class RecipeCategoryDetails extends StatefulWidget {
  ...
  RecipeCategoryDetails({required this.rool, required this.email, required this.id, required this.category});

  //const RecipeCategoryDetails({Key? key}) : super(key: key);

  @override
  _RecipeCategoryDetailsState createState() => _RecipeCategoryDetailsState();
}

class _RecipeCategoryDetailsState extends State<RecipeCategoryDetails> {
